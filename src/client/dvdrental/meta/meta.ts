 ...
 *  At: Sun Jun 06 2021 20:15:19 GMT+0800 (中国标准时间)
 */
    ...
    columns: [
      {
        ...
        table: "actor",
        dataType: "integer",
        defaultValue: "nextval('public.actor_actor_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "address",
        dataType: "integer",
        defaultValue: "nextval('public.address_address_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "category",
        dataType: "integer",
        defaultValue: "nextval('public.category_category_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "city",
        dataType: "integer",
        defaultValue: "nextval('public.city_city_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "country",
        dataType: "integer",
        defaultValue: "nextval('public.country_country_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "customer",
        dataType: "integer",
        defaultValue: "nextval('public.customer_customer_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "film",
        dataType: "integer",
        defaultValue: "nextval('public.film_film_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
      ...
      },
      {
        ...
        defaultValue: "'G'::public.mpaa_rating",
        isNullable: true,
    ...
    columns: [
      {
        ...
        table: "inventory",
        dataType: "integer",
        defaultValue: "nextval('public.inventory_inventory_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "language",
        dataType: "integer",
        defaultValue: "nextval('public.language_language_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "payment",
        dataType: "integer",
        defaultValue: "nextval('public.payment_payment_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "rental",
        dataType: "integer",
        defaultValue: "nextval('public.rental_rental_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "staff",
        dataType: "integer",
        defaultValue: "nextval('public.staff_staff_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
    ...
    columns: [
      {
        ...
        table: "store",
        dataType: "integer",
        defaultValue: "nextval('public.store_store_id_seq'::regclass)",
        isNumber: true,
        isKey: true,
      },
      {
